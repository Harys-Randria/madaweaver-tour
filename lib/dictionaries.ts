...
const dictionaries = {
  en: {
    ...
    destinationsPage: {
      ...
      title: "Explore Madagascar, region by region",
      subtitle: "Eight great regions, a thousand worlds — discover where your journey could take you.",
      regionLabel: "Region",
      exploreTours: "See tours in this region",
      relatedTitle: "Tours across this region",
    ...
    hero: {
      ...
      ctaDesign: "Design my journey",
      ctaBrowse: "See the tours",
      stat1: "Tours crafted",
    ...
    detail: {
      ...
      quoteText:
        "Love this tour? We'll tailor it to your dates, pace and budget — no commitment, reply within 24h.",
      quoteButton: "Design my version",
    ...
    landing: {
      ...
      regionDesc: {
        north: "Emerald islands and turquoise reefs around Nosy Be, the limestone tsingy of Ankarana and the lush forests of Amber Mountain.",
        highlands: "Royal palaces and markets of Antananarivo, the crater lakes of Antsirabe, Ambositra's woodcarving and the peaks of Andringitra.",
        west: "The razor-sharp Tsingy de Bemaraha, Kirindy's nocturnal wildlife, the Tsiribihina River and Morondava's iconic Avenue of the Baobabs.",
        east: "The haunting call of the Indri in Andasibe, whale watching off Sainte-Marie and the vast wilderness of Masoala.",
        south: "The dramatic canyons of Isalo, the spiny forests and ring-tailed lemurs of the deep south, and the coastal gems of Ifaty and Anakao.",
      },
    ...
    tailorMade: {
      eyebrow: "Tailor-made",
      title: "Design your own Madagascar",
      subtitle:
        "Tell us your dream and our local experts weave a journey that fits you — your pace, budget and desires. No payment now, free quote within 24h.",
      stepsTitle: "How it works",
      steps: [
        {
          title: "Share your vision",
          text: "A quick form or a WhatsApp chat: your dates, dreams and budget.",
        },
        {
          title: "We craft a draft",
          text: "Within 24h a local expert sends a tailored itinerary and quote.",
        },
        {
          title: "Refine together",
          text: "We adjust everything until it's perfectly yours — free of charge.",
        },
        {
          title: "Travel worry-free",
          text: "Guides, drivers and 24/7 support handle the rest on the ground.",
        },
      ],
      formTitle: "Start your custom trip",
      duration: "Trip length",
      durationPlaceholder: "e.g. 10–14 days",
      travellers: "Travellers",
      travellersPlaceholder: "e.g. 2 adults",
      style: "Travel style",
      stylePlaceholder: "wildlife, beaches, adventure, culture…",
      budget: "Budget per person (optional)",
      budgetPlaceholder: "e.g. €1500–2000",
      dates: "Approximate dates",
      datesPlaceholder: "e.g. September 2026",
      message: "Anything else?",
      messagePlaceholder: "Special requests, must-sees, pace…",
      submit: "Get my free quote",
      whatsapp: "Design on WhatsApp",
      note: "Opens a pre-filled message — nothing is sent until you press send.",
      reassure: "Free · No commitment · Reply within 24h",
    },
    footer: {
  ...
  fr: {
    ...
    destinationsPage: {
      eyebrow: "Destinations",
      title: "Explorez Madagascar, région par région",
      subtitle: "Huit grandes régions, mille univers — découvrez où votre voyage peut vous mener.",
      regionLabel: "Région",
      exploreTours: "Voir les circuits de cette région",
      relatedTitle: "Circuits dans cette région",
    ...
    hero: {
      ...
      ctaDesign: "Concevoir mon voyage",
      ctaBrowse: "Voir les circuits",
    ...
    detail: {
      ...
      quoteText:
        "Ce circuit vous inspire ? On l'adapte à vos dates, votre rythme et votre budget — sans engagement, réponse sous 24h.",
      quoteButton: "Concevoir ma version",
    ...
    landing: {
      ...
      regionDesc: {
        north: "Îles émeraude et récifs turquoise autour de Nosy Be, les tsingy calcaires de l'Ankarana et les forêts luxuriantes de la Montagne d'Ambre.",
        highlands: "Palais royaux et marchés d'Antananarivo, lacs de cratère d'Antsirabe, sculpture sur bois d'Ambositra et sommets de l'Andringitra.",
        west: "Les Tsingy de Bemaraha acérés, la faune nocturne de Kirindy, le fleuve Tsiribihina et la mythique Allée des Baobabs de Morondava.",
        east: "L'appel envoûtant de l'Indri à Andasibe, l'observation des baleines à Sainte-Marie et l'immensité sauvage de Masoala.",
        south: "Les canyons spectaculaires de l'Isalo, les forêts épineuses et makis catta du grand sud, et les joyaux côtiers d'Ifaty et Anakao.",
      },
    ...
    tailorMade: {
      eyebrow: "Sur-mesure",
      title: "Concevez votre Madagascar",
      subtitle:
        "Racontez-nous votre rêve : nos experts locaux tissent un voyage à votre image — votre rythme, votre budget, vos envies. Aucun paiement maintenant, devis gratuit sous 24h.",
      stepsTitle: "Comment ça marche",
      steps: [
        {
          title: "Partagez votre vision",
          text: "Un formulaire rapide ou un échange WhatsApp : vos dates, envies et budget.",
        },
        {
          title: "Nous créons un projet",
          text: "Sous 24h, un expert local vous envoie un itinéraire et un devis sur-mesure.",
        },
        {
          title: "On affine ensemble",
          text: "On ajuste tout jusqu'à ce que ce soit parfaitement vôtre — gratuitement.",
        },
        {
          title: "Voyagez l'esprit léger",
          text: "Guides, chauffeurs et assistance 24/7 s'occupent du reste sur place.",
        },
      ],
      formTitle: "Lancez votre voyage sur-mesure",
      duration: "Durée du voyage",
      durationPlaceholder: "ex. 10–14 jours",
      travellers: "Voyageurs",
      travellersPlaceholder: "ex. 2 adultes",
      style: "Style de voyage",
      stylePlaceholder: "faune, plages, aventure, culture…",
      budget: "Budget par personne (optionnel)",
      budgetPlaceholder: "ex. 1500–2000 €",
      dates: "Dates approximatives",
      datesPlaceholder: "ex. septembre 2026",
      message: "Autre chose ?",
      messagePlaceholder: "Demandes spéciales, incontournables, rythme…",
      submit: "Obtenir mon devis gratuit",
      whatsapp: "Concevoir sur WhatsApp",
      note: "Ouvre un message pré-rempli — rien n'est envoyé avant que vous n'appuyiez sur envoyer.",
      reassure: "Gratuit · Sans engagement · Réponse sous 24h",
    },
    footer: {
